...
\begin{exmp}
    ...
    bên trái không có nghĩa vì nếu biểu diễn theo dạng
    \ref{eq:number_in_decimal} thì các chữ số này không cần đến.
\end{exmp}
...
số bất kỳ của \(c\), ngoại trừ chữ số \(0\) nằm ở bên trái chữ số khác \(0\) đầu
tiên; các chữ số \(0\) này chỉ để xác định vị trí của dấu phẩy (như vậy, bất kỳ
chữ \(0\) khác đều là chữ số có nghĩa của \(c\)).
