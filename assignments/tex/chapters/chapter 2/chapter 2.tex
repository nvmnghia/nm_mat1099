...
\begin{solution}
    ...
    \begin{enumerate}[label = (\alph*)]
        ...
        \item We have the following table:
            ...
            % \begin{longtable}{r S[table-format=-1.2] S[table-format=1] S[table-format=1.3] S[table-format=-1.9]}
            %     \toprule
            %     \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
            %     \midrule
            %     \endfirsthead
        ...
        \item We have the following table:
            ...
            % \begin{longtable}{r S[table-format=-1] S[table-format=-1.2] S[table-format=-1.3] S[table-format=-2.7]}
            %     \toprule
            %     \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
            %     \midrule
            %     \endfirsthead
