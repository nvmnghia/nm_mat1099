...
\begin{solution}
    ...
    \begin{table}[hbt!]    % Default table floats (i.e. [btp]). [h] keeps it here.
...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.1] S[table-format=1.1] S[table-format=-1.1] S[table-format=-1.8]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
        ...
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.1] S[table-format=1.2] S[table-format=1.3] S[table-format=1.9]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
        ...
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.2] S[table-format=1] S[table-format=1.3] S[table-format=2.9]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
        ...
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1] S[table-format=-1.2] S[table-format=-1.3] S[table-format=3.7]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
...
\begin{solution}
    ...
    \begin{enumerate}[label=(\alph*)]
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.3] S[table-format=1.1] S[table-format=-1.4] S[table-format=-1.9]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
        ...
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.1] S[table-format=-1.3] S[table-format=-1.4] S[table-format=2.9]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
        ...
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.2] S[table-format=-1.3] S[table-format=-1.4] S[table-format=-1.9]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
        ...
        \item We have the following table:
            ...
            \begin{longtable}{r S[table-format=-1.3] S[table-format=1.2] S[table-format=1.4] S[table-format=1.9]}
                \toprule
                \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
                \midrule
...
\begin{solution}
    ...
    \begin{longtable}{r S[table-format=1.8] S[table-format=1.8] S[table-format=1.8] S[table-format=2.9]}
        \toprule
        \(n\)  &   {\(a_n\)}   &   {\(b_n\)}   &   {\(p_n\)}   &  {\(f(p_n)\)}  \\
        \midrule
            1  &  1            &  4            &  2.5          &  14.125        \\
